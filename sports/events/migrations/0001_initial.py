    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sponsor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='events.sponsor', verbose_name='Название')),
            ],
        ),
        migrations.CreateModel(
            name='Event',
            fields=[
                ...
                ('result', models.CharField(max_length=64, verbose_name='Результат')),
